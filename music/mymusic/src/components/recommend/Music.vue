...
export default {
    ...
    created(){
        ...
        //"id","name","author","album_title","si_proxycompany","pic_big","pic_small","si_proxycompany","url","weight"
        let reqest = {format:"json",from:"webapp_music",method:"baidu.ting.billboard.billList",type:2,size:20,offset:0}
